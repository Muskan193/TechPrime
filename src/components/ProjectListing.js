...
<img style={{ alignItems: "center", display: 'block', justifyContent: 'center', marginLeft: '700px', marginTop: '-110px' }} src={logo} alt='logo' />

        </div>
        
          <div class="container" style={{ float: 'left', margin: "20px 0px 0px 30px", height:"570px", zIndex: -1, border: "1px solid white", borderRadius: "10px", paddingTop: "5px", boxShadow: "5px 10px 18px #888888", background: "white" }}>
